...
const BundlePickerData=({page,modalType,data,setData,errorArray,removeProductFromList,temp,type})=>{
const {app}=useAPI()
 ...
 <Thumbnail
    ...
    />
                      ...
                      <div key={index} className="sd-bundle-title-section">
                        ...
                        {
                          (page=="productBundle" || (page=="volumeBundle" && modalType=="Product")) || (page=="productBundle" && type=='offeredProduct') && item.hasOnlyDefaultVariant == false && (
